  ...
  return (
    <div className="bg-gray-50 min-h-screen w-full flex flex-col items-center justify-start p-4 text-gray-900 overflow-x-hidden">
      ...
      <main className="w-full max-w-md mx-auto flex flex-col items-center justify-center space-y-6 z-10 mt-8 md:mt-12 animate-slide-up">
        <div className="w-full bg-white/70 backdrop-blur-2xl border border-black/5 rounded-2xl shadow-2xl shadow-black/10 overflow-hidden">
          <div className="cursor-pointer" onClick={() => openModal(ModalType.QuemSomos)}>
            <img
              src="/logo.png"
          ...
          <div className="p-6 md:p-8">
            <header className="flex flex-col items-center text-center">
              <p className="text-sm md:text-base text-gray-600 max-w-xs font-normal">
